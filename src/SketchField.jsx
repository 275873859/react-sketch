...
class SketchField extends PureComponent {
  ...
  _onObjectAdded = e => {
    ...
    this._setObjectChange('object:add',e.target);
  };
   ...
   */
  _onObjectMoving = e => {
    // this._setOnChange('object:moving',e);
  };
   ...
   */
  _onObjectScaling = e => {
    // this._setOnChange('object:scaling',e);
  };
   ...
   */
  _onObjectRotating = e => {
    // this._setOnChange('object:rotating',e);
  };
  ...
  _onObjectModified = e => {
    ...
    this._setObjectChange('object:modify',e.target);
  };
  ...
  _onObjectRemoved = e => {
    ...
    obj.__version = 0;
    this._setObjectChange('object:remove',e.target);
  };
  ...
  _onMouseDown = e => {
    ...
    this._setMouseChange('mouse:down',e);
  };
  ...
  _onMouseMove = e => {
    ...
    this._setMouseChange('mouse:move',e);
  };
  ...
  _onMouseOut = e => {
    ...
    this._setMouseChange('mouse:out',e);
  };
  ...
  _onMouseUp = e => {
    ...
    this._setMouseChange('mouse:up',e);
  };

  _setObjectChange(type,e) {
  ...
  _setMouseChange(type,e) {
    if (this.props.onMouseChange) {
      let onMouseChange = this.props.onMouseChange;
      setTimeout(() => {
        onMouseChange(type,e)
      }, 10);
    }
  }
  ...
  getObjectById = (id) => {
    ...
    const objects = canvas.getObjects();
    for (let i in objects) {
      if (objects[i]._id === id) return objects[i];
    }
  };
  ...
  getHighestId = () => {
    ...
    var highestId = 0;
    for (let i in objects) {
      if (objects[i]._id > highestId)  highestId = objects[i]._id;
    }
    return highestId;
  };
  ...
  removeSelected = () => {
    ...
    if (activeObj) {
      ...
      selected.forEach(obj => {
        ...
        this._history.keep([obj, state, state]);
        canvas.remove(obj);
        this._setObjectChange('object:remove',obj);
      });
